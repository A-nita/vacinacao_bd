...
INSERT INTO grupo_prioritario (categoria, descricao) VALUES 
('IDOSO', 'Idoso é todo indivíduo com 60 anos ou mais.'),
('OBESO', ' Distúrbio que envolve excesso de gordura corporal, aumentando o risco de problemas de saúde.'),
('DIABÉTICO', 'Pessoas com doenças que resultam em alto nível de glicose no sangue.'),
('PROFISSIONAL DA SAÚDE', 'Pessoa que trabalha em uma profissão relacionada às ciências da saúde.'),
('PROFISSIONAL DA EDUCAÇÃO', 'Todos os profissionais que atuam em escolas e instituições de ensino são considerados profissionais da Educação');
...
--LOTE
INSERT INTO lote (total_doses, marca, data_fabricacao, data_validade) VALUES
...
( 2, 'Lote teste', '2022-04-27', '2024-04-27');

--CIDADAO
INSERT INTO cidadao (cpf,nome, data_nascimento, telefone,sexo,bairro_id,rua,numero)VALUES
...
INSERT INTO vacina (n_lote, cpf_vacinado, cpf_aplicante, cnes, data_aplicacao) VALUES
...
(16, '55609888042', '18556602371', '2086964', '2022-03-15'),
(16, '55609888042', '18556602371', '2086964', '2022-03-15');


--TESTE TRIGGER cadastrar vacina em lote vazio

-- INSERT INTO vacina (n_lote, cpf_vacinado, cpf_aplicante, cnes, data_aplicacao) VALUES
-- 	(16, '55609888042', '18556602371', '2086964', '2022-03-15')
-- ;
-- UPDATE vacina SET n_lote = 16 WHERE id = 1
